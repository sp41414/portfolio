            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-3">
                ...
                <div className="group relative rounded-lg border-2 border-neutral-200 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200 dark:border-neutral-800 p-4 hover:shadow-lg shadow-neutral-300 dark:shadow-neutral-800">
                    ...
                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center gap-2">
                        <a
                            href="https://github.com/sp41414/chess"
                            target="_blank"
                        ...
                        <a
                            href="https://github.com/sp41414/chess/releases/download/v1.0.0/chess-windows-amd64.zip"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg
                                ...
                                className="size-5 stroke-black dark:stroke-white shrink-0 hover:stroke-neutral-700 hover:dark:stroke-neutral-300 transition-all duration-200"
                            >
                                <path d="M15 3h6v6" />
                                <path d="M10 14 21 3" />
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">
                        A desktop chess application featuring a custom
                        bitboard-based engine implemented in Go. The UI is built
                        with Wails, a lightweight cross-platform alternative to
                        Electron, and React.
                    </p>
